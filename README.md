...
\[!\[Bloxd.io](https://img.shields.io/badge/Bloxd.io-Libraries-ff69b4?style=for-the-badge)](https://bloxd.io)

\[!\[Free](https://img.shields.io/badge/Price-Free-8A2BE2?style=for-the-badge)](#license)



A collection of useful libraries for \[Bloxd.io](https://bloxd.io), made by \*\*MangoIsSleepy\*\*.
...
1\. Create a new code file in your Bloxd world.

2\. Copy the library into that file.

3\. Give the file the correct name.

4\. Import it wherever you need it.
...
| \[MathLib](#mathlib) | Math, vectors, interpolation and noise!!1!1 |

| \[WorldGen](#worldgen) | Procedural terrain generation!! |

| \[Pathfinder](#pathfinder) | da best path finding |

| \[Scheduler](#scheduler) | Like set interval \& set timeout with other features |

| \[RoomGen](#roomgen) | Procedural room gen |
